...
include("../connection.php");
		...
		<div class="custom-scrollbar table-wrapper" style="margin-top: 2vh;">
			<table class="table table-striped table-bordered table-hover" id="myTable"  style="font-size:2vh;" align="center">
				...
				<tr>
					<th class="table-head" style="width: 5%;">Id</th>
					...
					<th class="table-head" style="width: 10%;">Army No</th>
					<th class="table-head" style="width: 15%;">Rank</th>
					<th class="table-head" style="width: 20%;">Name</th>
					<th class="table-head" style="width: 10%;">Status</th>
					<th class="table-head" style="width: 20%;">Enter Result</th>
					
				</tr>
				</thead>
		<?php
			$date=date('Y-m-d');		
$query=" SELECT * FROM admission where fwd_pathology='Yes' and test_stage='Initiated'order by admn_id DESC";
		...
		if($rowa=mysqli_fetch_assoc($resulta)){
			...
			?><tr>
					<td style="text-align: center;"><?php echo $rows['patient_id']; ?></td>
