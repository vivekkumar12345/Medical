...
if($_POST["action"] == "update")
	{
		...
		$query = "UPDATE admission SET history='".$_POST['history']."', Diag='".$_POST['diag']."', treatment='".$_POST['treatment']."', investigation='".$_POST['investigation']."' WHERE admn_id = '".$_POST["hidden_id"]."' ";
		$result=mysqli_query($conn,$query);
			if($result)
			{
