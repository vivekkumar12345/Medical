...
if(isset($_POST["action"]))
{
	...
	{	
		...
		$date=date('Y-m-d');
$sql = "
		INSERT INTO patient_details (rel, name_of_patient, age, month, army_no, service, rank, name, date_of_reg, unit) VALUES ('".$_POST["rel"]."', '".$_POST["name_of_patient"]."', '".$_POST["age"]."', '".$_POST["month"]."', '".$_POST["army_no"]."', '".$_POST["service"]."', '".$_POST["rank"]."', '".$_POST["name"]."', '$date', '".$_POST["unit"]."')";
