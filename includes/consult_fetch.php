...
<center>
		...
		<div class="custom-scrollbar table-wrapper" style="margin-top: 2vh;">
			<table class="table table-striped table-bordered table-hover"  style="font-size:2vh;" id="myTable" align="center">
				<thead style="text-align: center;">
				
				<tr>
					<th class="table-head" style="width: 7%;">OPD No</th>
					<th class="table-head" style="width: 7%;">History</th>
					<th class="table-head" style="width: 10%;">Rel</th>
					<th class="table-head" style="width: 15%;">Name of Patient</th>
					<th class="table-head" style="width: 10%;">Age</th>
					<th class="table-head" style="width: 12%;">Army No</th>
					<th class="table-head" style="width: 13%;">Rank</th>
					<th class="table-head" style="width: 15%;">Name</th>
					<th class="table-head" style="width: 7%;">Diag</th>
					
				</tr>
				</thead>
		<?php
		$date=date('Y-m-d');
		$query=" SELECT * FROM admission where date='$date' and status='Initiated' and department='".$_SESSION['department']."' order by admn_id ASC";
		...
		$rows=mysqli_fetch_assoc($results)
			...
			?><tr>
					<td style="text-align: center;"><?php echo $row['day_id']; ?></td>
					...
					<td style="text-align: center;">
					<button type="button" name="diag" class="diag" id="<?php echo $row['admn_id']; ?>" style="color:blue; background:rgba(0,0,0,0); border-style:none; font-size:3vh"><i class="fa fa-edit fa-sm"></i></button>
				</td>
