		...
		<div class="custom-scrollbar table-wrapper" style="margin-top: 2vh;">
			<table class="table table-striped table-bordered table-hover" id="myTable"  style="font-size:2vh;" align="center">
				...
				<tr>
					...
					<!-- <th class="table-head" style="width: 7%;">Biodata</th> -->
					...
					<th class="table-head">Diag</th>
					<th class="table-head">Investigation</th>
					
				</tr>
				</thead>
		<?php
		
$query=" SELECT *, date_format(date,'%d/%m/%Y') as dt  FROM admission where status='Diagnosed' and department='".$_SESSION['department']."' order by admn_id DESC";
		...
		$rows=mysqli_fetch_assoc($results)
			...
			?><tr>
					...
					<td style="text-align: center;"><?php echo $row['Diag']; ?></td>
					<td style="text-align: center;"><?php echo $row['investigation']; ?></td>
				</tr>
